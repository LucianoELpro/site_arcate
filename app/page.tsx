...
// Landing de marketing portada de references/home-about/home-about/home.jsx.
// Usa el tema de la landing (app/home-arcade.css), por eso la raíz lleva `.home-av`.
//
// Navegación (spec 02 + decisión "apuntar a rutas reales"):
//   EXPLORAR JUEGOS / VER TODOS LOS JUEGOS / INSERTAR MONEDA → /juegos
//   CREAR CUENTA / EMPEZAR GRATIS                            → /auth
//   mini-cards (detalle)                                     → /juego/[id]
//   VER SALÓN                                                → /salon-de-la-fama

import Link from "next/link";
import { useEffect, useRef, type RefObject } from "react";
import { HOME_GAMES, type HomeGame } from "@/lib/home-games";
...
function MiniCard({ game }: { game: HomeGame }) {
  return (
...
// Iconos pixel 16x16 dibujados con rects, con glow del color del padre.
...
export default function Home() {
  ...
  return (
    <div className="home-av home fade-in" ref={containerRef}>
      {/* HERO */}
