...
// Página "Acerca de" portada de references/home-about/home-about/about.jsx.
// Usa el tema de la landing (.home-av) + estilos co-localizados (./sobre-nosotros.css).
//
// Diferencia con la referencia: el formulario envía de verdad vía POST /api/contacto
// (Resend). Estados: idle | sending | sent | error. El éxito reproduce la terminal
// VAULT-OS tal cual; el error es un bloque nuevo con la misma estética (ver spec 03).
...
// Anima las secciones .reveal al entrar en viewport (IntersectionObserver).
...
export default function About() {
  ...
  return (
    <div className="home-av about fade-in" ref={containerRef}>
      {/* ABOUT */}
            ...
            {status === "sent" ? (
              ...
              <div className="terminal-success terminal-error">
                ...
                <div className="term-body">
                  <div className="line"><span className="prompt">vault@arcade:~$</span> ./send_message --to=team</div>
                  <div className="line dim">[OK] Conectando con servidor…</div>
                  <div className="line fail">[FAIL] Transmisión interrumpida…</div>
                  <div className="line error">&gt; NO PUDIMOS ENVIAR TU MENSAJE. INTÉNTALO DE NUEVO.<span className="caret">_</span></div>
                  <div style={{ marginTop: 18 }}>
